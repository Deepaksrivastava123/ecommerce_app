...
import 'package:ecommerce_app/Views/CategoryScreen/item_details.dart';
                 ...
                 child: Column(
                     ...
                     children: [
                       SingleChildScrollView(
                         ...
                         child: Row(
                           children:List.generate(controller.subcat.length, (index) => '${controller.subcat[index]}'.text.size(12).
                           fontFamily(semibold).
                           color(darkFontGrey).
                           makeCentered().box.white.roundedSM.size(120, 60).
                         ...
                         child: Container(
                           ...
                           child: GridView.builder(
                               ...
                               itemBuilder: (context,index){
                                 ...
                                 ).box.white.margin(EdgeInsets.symmetric(horizontal: 4)).outerShadowSm.roundedSM.padding(EdgeInsets.all(12)).make().onTap(() {
